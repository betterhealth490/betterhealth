...
export default function HomePage() {
    return (
        <main className="animate-gradient absolute top-0">
            <div>
                <ScreenOne>
                    <ScreenOneText />
                    <ScreenOneButtons />
...
function ScreenFour(props: { children: React.ReactNode[] }) {
    return (
        <div className="animate-gradient flex h-[500px] w-full flex-col items-center justify-center gap-y-4 text-white">
            {props.children}
        </div>
    );
}
