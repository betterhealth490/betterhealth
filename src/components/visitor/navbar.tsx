...
export function Navbar() {
    ...
    return (
        <header
            className={`sticky top-0 z-50 flex h-14 w-full items-center ${scroll ? "border border-b border-border/40 bg-white text-primary" : "bg-opacity-0 text-white"}`}
        >
            <div className="flex w-full justify-between gap-x-3 px-32 align-middle">
                <div className="flex gap-x-1 space-x-1">
                    ...
                    <Link href="/about">
                        <Button
                            variant="link"
                            className={`${scroll ? "bg-white text-primary" : "bg-opacity-0 text-white"} transition-none`}
                        >
                            About
                        </Button>
                    </Link>
